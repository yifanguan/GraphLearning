...
def run(dataset_name, num_mp_layers, mp_hidden_dim,
...
def main_experiment(dataset_name, num_mp_layers, mp_hidden_dim=3000, optimizer_lr=0.01,
    ...
    train_loss_list, valid_loss_list, test_loss_list, train_learning_loss_list, valid_learning_loss_list, test_learning_loss_list, norms_list = \
            run(dataset_name, num_mp_layers, mp_hidden_dim,
    ...
    return best_val, best_test, train_accuracy_list, valid_accuracy_list, test_accuracy_list, energy_loss_list, train_loss_list, valid_loss_list, test_loss_list, \
            train_learning_loss_list, valid_learning_loss_list, test_learning_loss_list, norms_list
...
for energy_lambda in lambdas:
    ...
    test_loss_list, train_learning_loss_list, valid_learning_loss_list, test_learning_loss_list, norms_list = \
