from utils.distinct_features_and_rank import generate_expressive_power_plot, generate_expressive_power_plot_transfer_learning

# generate_expressive_power_plot(dataset_name='Cora', mp_depth=2, tolerance=1e-5, dim_list=[50, 150, 300, 500, 1000, 2000, 4000, 8000])

generate_expressive_power_plot(dataset_name='texas', mp_depth=6, tolerance=1e-5, dim_list=[50])
